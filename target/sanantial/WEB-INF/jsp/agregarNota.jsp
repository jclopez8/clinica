   ...
   <form:form  method="post"  name="cambiarStatusForm" >
      ...
      <table border=0 cellSpacing=0 cellPadding=0 width=780 align=center>
        <tbody>
            ...
            <td>
              ...
              <table>
                   ...
                   <tr>
                      ...
                      <td> <textarea id="observationsPopup" rows="8" cols="30">${observaciones}</textarea> </td>
                   </tr>
           ...
           <tr>
              <td align="center">
                  <input id="Aceptar" name="Aceptar" type="button" value="Aceptar" onclick="javascript:salvarNota()"/>
